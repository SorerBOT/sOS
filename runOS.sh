...
x86_64-elf-gcc -ffreestanding -m32 -g -c "$LIB$MEMSET_LIB.c" -o "$BIN$MEMSET_LIB.o"
...
x86_64-elf-gcc -ffreestanding -mno-red-zone -m64 -g -c "$KERNEL.c" -o "$BIN/$KERNEL.o"
x86_64-elf-gcc -ffreestanding -mno-red-zone -m64 -g -c "$LIB$MATH_LIB.c" -o "$BIN$MATH_LIB.o"
x86_64-elf-gcc -ffreestanding -mno-red-zone -m64 -g -c "$LIB$MEMSET_LIB.c" -o "$BIN$MEMSET_LIB.o"
